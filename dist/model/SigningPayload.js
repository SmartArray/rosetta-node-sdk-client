...
var SigningPayload = /*#__PURE__*/function () {
   ...
   * @param address {String} The network-specific address of the account that should sign the payload.
   * @param hexBytes {String} 
   */
  function SigningPayload(address, hexBytes) {
    _classCallCheck(this, SigningPayload);

    SigningPayload.initialize(this, address, hexBytes);
  }
  /**
  ...
  _createClass(SigningPayload, null, [{
    key: "initialize",
    value: function initialize(obj, address, hexBytes) {
      obj['address'] = address;
