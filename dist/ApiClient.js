  ...
  */
  ...
  _createClass(ApiClient, [{
    ...
    */
    ...
    key: "callApiPromised",
    value: function callApiPromised(path, httpMethod, pathParams, queryParams, headerParams, formParams, bodyParam, authNames, contentTypes, accepts, returnType, apiBasePath) {
      var _this4 = this;
      ...
      return new Promise(function (resolve, reject) {
        request.end(function (error, response) {
          if (error) {
            ...
            try {
              var data = _this4.deserialize(response, returnType);

              if (_this4.enableCookies && typeof window === 'undefined') {
                _this4.agent._saveCookies(response);
              }
