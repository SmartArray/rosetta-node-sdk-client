...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rosetta.ConstructionDeriveRequest();
  });
  ...
  describe('ConstructionDeriveRequest', function() {
    it('should create an instance of ConstructionDeriveRequest', function() {
      ...
      //var instane = new Rosetta.ConstructionDeriveRequest();
      //expect(instance).to.be.a(Rosetta.ConstructionDeriveRequest);
    });
